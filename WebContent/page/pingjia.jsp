...
<ul class="pingjia">
	<form action="" method="post" id="addevaluate" enctype="multipart/form-data">
		...
		<input type="hidden" name="commodityId" id="commodityId" value="${goods_id}">
		 <li class="pingjia_nr">
		      <div class="pingjia_nr_top">
			      <a href="#"><img src="${order.goods_img }" alt=""/></a>
				  <div class="pingjia_nr_bt"><h2>${order.goods_name }</h2>
...
//     	}
    	...
    	jQuery.ajax({
    		...
    		success : function(msg) {
    			...
    			if (msg == "1") {
    				alert('感谢您的评价');
    				window.location.href='/weixin/page/goodsListById.html?goods_id='+$("#commodityId").val();
    			} else {

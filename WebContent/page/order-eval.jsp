...
<div class="sp_top">
	<div class="sp_top_bt">
	    <i class="iconfont icon-zuo" onclick="window.location.href='goodsListById.html?goods_id=${commodityId}'"></i>
...
<div class="pinglun">
	...
	<button class="my-btn1 f-r" onclick="window.location.href='evaluate/tojdbEvaluatePage.html?id=${commodityId}'">发表评价</button>
</div>
...
function chickGoods(grade) {
	...
	var url = "showjdbEvaluateAj.html"
	$.ajax({
		type : "POST",
		url : encodeURI(url),

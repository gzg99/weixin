...
<body>
	...
	<ul class="quanbu-ul11"style="height: 40px; padding: 5px 0;">
    	<li style="height:40px;">
            ...
            <a href="index.html" class="qu-ul1a li_indstyle" id="li_indstyle">首页</a>
        </li>
    	<li style="height:40px;">
        	<div class="qu-tu1" align="center" style="height:28px;">
            ...
            <a href="insertView.html" class="qu-ul1a" id="li_indstyle">发布</a>
        </li>
            ...
            <a href="center.html" class="qu-ul1a" id="li_indstyle">我的</a>
        </li>

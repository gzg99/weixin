...
<body>
	...
	<div class="pd-20" style="width: 80%">
			<input type="hidden" id="id" value="${sellerArea.id }">
			<div class="row cl">			
...
<!-- 					<a html="#" onclick="getMap();" style="color: red;">获取地图地址</a><br> -->
			...
			<div class="row cl">
				<label class="form-label col-2"> </label>
				<input id="filepath" type="hidden" value="${sellerArea.firstLink }">
				<div class="formControls col-10" id="img">
					<img alt="" src="${sellerArea.firstLink}" style="width:100px;height:100px">
				</div>
			</div><br>
			<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-2"> </label>
				<input id="filepath1" type="hidden" value="${sellerArea.secondLink }">
				<div class="formControls col-10" id="img1">
					<img alt="" src="${sellerArea.secondLink}" style="width:100px;height:100px">
				</div>
			</div><br>
			<div class="row cl">
			...
			<div class="row cl">
				<label class="form-label col-2"> </label>
				<input id="filepath2" type="hidden" value="${sellerArea.sellerImg }">
				<div class="formControls col-10" id="img2">
					<img alt="" src="${sellerArea.sellerImg}" style="width:100px;height:100px">
				</div>
			</div><br>
			<div class="row cl">
				<label class="form-label col-2">详情：</label>
				<div class="formControls col-10">
					<textarea name="content" id="sellerDetail" style="width: 80%;height: 260px;">${sellerArea.sellerDetail }</textarea>
				</div>
			</div><br>	
			<br>

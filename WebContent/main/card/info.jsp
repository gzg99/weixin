...
<body>
	...
	<div class="pd-20" style="width: 80%">
			<div class="row cl">
						<input type="hidden" id="cardId" value="${card.cardId }">
						<label class="form-label col-2">名称：</label>
						<div class="formControls col-10">
							<input type="text" id="cardName"
								placeholder="请填写名称" value="${card.cardName }" class="input-text" style="width: 80%">
						</div>
			</div><br>
			<div class="row cl">
				...
				<div class="row cl">
						...
						<input id="filepath" type="hidden" value="${card.cardImg}">
						<div class="formControls col-10" id="img">
							<img alt="" src="${card.cardImg}" style="width:100px;height:100px">
						</div>
					</div>	
					<br>
					<div class="row cl">
						...
						<div class="formControls col-10">
							<input type="text" id="cardPrice"
								placeholder="请填写价格" value="${card.cardPrice }" class="input-text" style="width: 80%">
						</div>
					</div><br>
					<div class="row cl">
						...
						<div class="formControls col-10">
							<textarea name="content" id="cardDetail" style="width: 80%;height: 260px;">${card.cardDetail }</textarea>
						</div>
			</div>
			<br>	
					<br>
	...
	<script type="text/javascript">
		function add(){
			...
			card.cardName = $('#cardName').val();
			card.cardImg = $('#filepath').val();
			card.cardPrice = $('#cardPrice').val();
			card.cardDetail = $('#cardDetail').val();

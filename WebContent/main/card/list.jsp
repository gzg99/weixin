...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="addCardjsp.html"
				...
				<tbody>
					<c:forEach items="${cards}" var="list" varStatus="s">
						<tr class="text-c">
							...
							<td>${list.cardName}</td>
							<td><img alt="" src="${list.cardImg}" width="50" height="50"> </td>
							<td>${list.cardPrice}</td>
							<td>${list.addTime}</td>
							
							<td>
								<a href="findCardById.html?id=${list.cardId}">编辑</a>&nbsp;&nbsp;
								<a href="javascript:;" onclick="del('${list.cardId}')">删除</a>
							</td>					
						</tr>
					</c:forEach>

...
<script>
	...
	KindEditor.ready(function(K) {
		editor = K.create('textarea[name="pictureNote"]', {
			resizeType : 1,
...
<body>
	<%--<form action="" method="post" id="loveRelay" enctype="multipart/form-data">
		<div class="pd-20" style="width: 80%">
			...
			<div class="row cl">
				<label class="form-label col-2">组织ID：</label>
			...
			<br>
			<div class="row cl">
				<label class="form-label col-2">组织名称：</label>
				<div class="formControls col-10">
					<input type="text" 
					       id="organizationName" 
			...
			<br>
			<div class="row cl">
				<label class="form-label col-2">公益首页宣传图：</label>
			...
			<div class="row cl">
				...
				<div class="formControls col-10">
					<textarea name="pictureNote" 
					          id="pictureNote"
						      style="width: 80%; 
						      height: 260px;">${jdbLoveRelay.pictureNote }</textarea>
				</div>
			</div>
			<br> <br>

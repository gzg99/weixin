...
<body>
	...
	<div class="pd-20" style="width: 80%">
		<input type="hidden" id="id" value="${decoration.id }">
		<div class="row cl">
		...
		<div class="row cl">
			...
			<input id="filepath" type="hidden" value="${decoration.companyImg }">
			<div class="formControls col-10" id="img">
				<img alt="" src="${decoration.companyImg }" style="width:100px;height:100px">
			</div>
		</div><br>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<div class="formControls col-10">
					<textarea name="content1" id="companyIntrl" style="width: 80%;height: 260px;">${decoration.companyIntrl }</textarea>
				</div>
			</div>
		</div><br>

...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="decorationAddJsp.html"
		...
		<div class="mt-20">
			<table
				...
				<tbody>
					<c:forEach items="${list}" var="decoration" varStatus="s">
						<tr class="text-c">
	...
	function upPage() {
		if (currentPage > 1) {
			window.location.href = 'decorationList.html?pageNo='
	...
	function fpage() {
		window.location.href = 'decorationList.html?pageNo=1&pageSize=10';
		return;
	}
	function epage() {
		window.location.href = 'decorationList.html?pageNo=' + totalPage+'&pageSize=10';
		return;
	}
	function spage() {
		var seastr =$('#seastr').val();
		if (parseInt(seastr)< parseInt(totalPage)||parseInt(seastr)== parseInt(totalPage)) {
			window.location.href = 'decorationList.html?pageNo=' + seastr+'&pageSize=10';
		}
		return;
	}
	</script>

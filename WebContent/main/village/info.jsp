...
<body>
	<nav class="breadcrumb">
		...
		小区管理 <span class="c-gray en">&gt;</span>  <a
	...
	<div class="pd-20" style="width: 80%">
		<input type="hidden" id="id" value="${village.id }">
		<div class="row cl">
			<label class="form-label col-2">名称：</label>
			<div class="formControls col-10">
				<input type="text" id="villageName"
					placeholder="请填写小区名称" class="input-text" value="${village.villageName }" style="width: 80%">
			</div>
		</div><br>
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="longitude"
					placeholder="请填写经度" value="${village.longitude }" class="input-text" style="width: 80%">
			</div>
		</div><br>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="latitude"
					placeholder="请填写纬度" value="${village.latitude }" class="input-text" style="width: 80%">
			</div>
		</div><br>	
		<br>
	...
	function update(){
		...
		$.ajax({
			url:'updateVillage.html',
			type:'post',
			data:'id='+id+'&villageName='+villageName+'&longitude='+longitude+'&latitude='+latitude,
			success:function(rs){
				if(rs==1){
					alert("更新成功！");

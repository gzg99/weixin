...
<body>
	...
	<div class="pd-20">
		<div class="cl pd-5 bg-1 bk-gray mt-20">
			<span class="l"> <a href="villageAddjsp.html"
		...
		<div class="mt-20">
			<table
				...
				<tbody>
					<c:forEach items="${list}" var="village" varStatus="s">
						<tr class="text-c">
							...
							<td>
							    <a href="getVillageById.html?id=${village.id}">编辑</a>&nbsp;&nbsp;
							    <a href="javascript:;" onclick="del('${village.id}')">删除</a>
							</td>					
						</tr>
					</c:forEach>
	...
	function upPage() {
		if (currentPage > 1) {
			window.location.href = 'getVillageList.html?pageNo='
	...
	function fpage() {
		window.location.href = 'getVillageList.html?pageNo=1&pageSize=10';
		return;
	}
	function epage() {
		window.location.href = 'getVillageList.html?pageNo=' + totalPage+'&pageSize=10';
		return;
	}
	function spage() {
		var seastr =$('#seastr').val();
		if (parseInt(seastr)< parseInt(totalPage)||parseInt(seastr)== parseInt(totalPage)) {
		window.location.href = 'getVillageList.html?pageNo=' + seastr+'&pageSize=10';
		}
		return;
	}
	</script>

...
<body>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="villageName"
					placeholder="请填写小区名称" value="" class="input-text" style="width: 80%">
			</div>
		</div><br>
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="longitude"
					placeholder="请填写经度" value="" class="input-text" style="width: 80%">
			</div>
		</div><br>
		...
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="latitude"
					placeholder="请填写纬度" value="" class="input-text" style="width: 80%">
			</div>
		</div><br>	
		<br>
	...
	function add(){
		...
		$.ajax({
			url:'addVillage.html',
			type:'post',
			data:'villageName='+villageName+'&longitude='+longitude+'&latitude='+latitude,
			success:function(rs){
				if(rs==1){
					alert("添加成功！");

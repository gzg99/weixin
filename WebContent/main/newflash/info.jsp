...
<body>
	...
	<div class="pd-20" style="width: 80%">
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="content" value="${newsFlash.content}" class="input-text" style="width: 80%">
			</div>
		</div>
		<br>	
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="file" id="file" name="file" value="${newsFlash.head_img}" class="input-text" style="width: 80%" onchange="upload()">
			</div>
		</div>
		<br>
		<div class="row cl">
		...
		<br><br>
		<input type="hidden" id="id" value="${newsFlash.id }">
	...
	<script type="text/javascript">
		function add(){
			...
			obj.headImg=$('#filepath').val();
			obj.id=$('#id').val();
			$.ajax({
				url:'updateNewsFlash.html',
				type:'post',
				data:obj,
				success:function(rs){
					if(rs=="true"){

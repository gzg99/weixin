...
<head>
    ...
    <script type="text/javascript"
            src="https://webapi.amap.com/maps?v=1.4.9&key='9e1d9c358dabbf185022c2c8cddaba94'&plugin=AMap.Autocomplete"></script>
            ...
            <div class="row cl">
                ...
                <div class="formControls col-10">
                    <input type="text" id="longitude"
                           placeholder="请填写经度" name="longitude" value="${seller.longitude }" class="input-text" style="width: 80%">
                </div>
            </div>
            <br>
            <div class="row cl">
                ...
                <div class="formControls col-10">
                    <input type="text" id="latitude"
                           placeholder="请填写纬度" name="latitude" value="${seller.latitude }" class="input-text" style="width: 80%">
                </div>
            </div>
            <br>
            <label class="form-label col-2" style="margin-top:20px;">商家详情：</label>
            <div class="formControls col-10" style="margin-top:20px;">
                <textarea name="sellerDetail" id="sellerDetail"
                          style="width: 80%;height: 100px;">${seller.sellerDetail}</textarea>
            </div>
            <div class="row cl">

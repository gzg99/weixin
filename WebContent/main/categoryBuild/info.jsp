	...
	<div class="pd-20" style="width: 80%">
		<div class="row cl">
			...
			<div class="formControls col-10">
				<input type="text" id="firstCategory"
					placeholder="请填写名称" value="${category.firstCategory}" class="input-text" style="width: 80%">
			</div>
		</div><br>
		<div class="row cl">
			<label class="form-label col-2">二级分类：</label>
			<div class="formControls col-10">
				<input type="text" id="secondCategory"
					placeholder="请填写名称" value="${category.secondCategory}" class="input-text" style="width: 80%">
			</div>
		</div>
		<br>
		<br><br>
